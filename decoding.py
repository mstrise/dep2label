def decode_1(decoded_sentence, decoded_words, homeless_nodes):
    for index_of_word in decoded_sentence:
        if not index_of_word == 0:
            ...
            elif int(info_about_word[5] == 0) and int(info_about_word[6] == "root"):
                words_full_info = {
                    1: index_of_word,
                    2: info_about_word[2],
                    3: info_about_word[3],
...
def decode_2(decoded_sentence, decoded_words, homeless_nodes):
    for index_of_word in decoded_sentence:
        if not index_of_word == 0:
            info_about_word = decoded_sentence[index_of_word]
...
def decode_3(decoded_sentence, decoded_words, homeless_nodes):
    for index_of_word in decoded_sentence:
        if not index_of_word == 0:
            found_head = False
            info_about_word = decoded_sentence[index_of_word]
...
def assignHeadL(node_index, info_about_word, head, decoded, abs_posit):
    ...
    for index in range(node_index - 1, -1, -1):
        ...
        postag_candidate = info_candidate_word[4]
