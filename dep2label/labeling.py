...
class Encoding:
    ...
    def encode(self, gold_file_to_encode_labels, task, pos):
        """
    ...
    def decode(self, sentences_with_depend, output):
        """
        ...
        for sent_id in sentences_with_depend:
            ...
            decoded_words, homeless_nodes = decoding.decode_3(sent_with_index)
