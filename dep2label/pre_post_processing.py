...
def find_candidates_for_root(decoded_words, homeless_nodes, root):
    ...
    for candidate in homeless_nodes:
        candidateRootMinus1 = homeless_nodes[candidate]
        if candidateRootMinus1[5] == -1 and candidateRootMinus1[6]==root:
            candidateRootMinus1[5] = 0
            candidates_for_root.update({candidate:candidateRootMinus1})
    ...
    if not foundRoot:
        ...
        for candidate in decoded_words:
            candidateRootMinus1 = decoded_words[candidate]
            if candidateRootMinus1[6] == root:
                #print(".........")
                #print(candidateRootMinus1)
                candidateRootMinus1[5] = 0
                #print(candidateRootMinus1)
